...
class CreateActivity201709Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fsdp_activity_list_201709', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fsdp_activity_list_201709');
    }
}
